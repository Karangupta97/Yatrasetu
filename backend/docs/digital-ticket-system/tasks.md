...
- [ ] 1. Create Mongoose models for LocalTicket, ExpressTicket, and FraudAlert
  - [-] 1.1 Create `src/models/LocalTicket.ts`
  ...
  - [~] 1.2 Create `src/models/ExpressTicket.ts`
  ...
  - [~] 1.3 Create `src/models/FraudAlert.ts`
  ...
  - [~] 1.4 Remove the old `src/models/Ticket.ts` placeholder
    - Delete the file (it will no longer be imported anywhere after this task set)
    - _Requirements: 14.4_

- [ ] 2. Implement ticket identifier generation utilities
  - [~] 2.1 Create `src/utils/ticketId.ts`
  ...
  - [~] 2.2 Write property tests for `generateUTSNumber`
  ...
  - [~] 2.3 Write property tests for `generatePNR`
...
- [ ] 3. Implement IST-aware ticket validity engine
  - [~] 3.1 Create `src/utils/ticketValidity.ts`
  ...
  - [~] 3.2 Write property tests for `isLocalTicketValid`
  ...
  - [~] 3.3 Write property tests for `isExpressTicketValid`
...
- [~] 4. Checkpoint — core logic verified
  - Ensure all tests pass, ask the user if questions arise.

- [ ] 5. Implement TTE JWT middleware
  - [~] 5.1 Create `src/middleware/verifyTTEJWT.ts`
  ...
  - [~] 5.2 Write unit tests for `verifyTTEJWT`
